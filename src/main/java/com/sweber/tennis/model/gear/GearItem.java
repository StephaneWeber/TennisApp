...
public enum GearItem {
    ...
    PATRIOT_6(RACKET, new Config(new Attributes(0, 0, 0, 0, 19, 6), 0, 6)),
    PATRIOT_7(RACKET, new Config(new Attributes(0, 0, 0, 0, 23, 6), 0, 7)),
    PATRIOT_8(RACKET, new Config(new Attributes(0, 0, 0, 0, 25, 7), 0, 8)),
    ...
    PANTHER_5(RACKET, new Config(new Attributes(0, 0, 0, 0, 18, 0), 15000, 5)),
    PANTHER_6(RACKET, new Config(new Attributes(0, 0, 0, 0, 22, 0), 15000, 6)),
    PANTHER_7(RACKET, new Config(new Attributes(0, 0, 0, 0, 26, 0), 15000, 7)),
    PANTHER_8(RACKET, new Config(new Attributes(0, 0, 0, 0, 28, 0), 15000, 8)),
    PANTHER_9(RACKET, new Config(new Attributes(0, 0, 0, 0, 31, 0), 15000, 9)),
    PANTHER_10(RACKET, new Config(new Attributes(0, 0, 0, 0, 34, 0), 15000, 10)),
    PANTHER_11(RACKET, new Config(new Attributes(0, 0, 0, 0, 36, 0), 15000, 11)),
